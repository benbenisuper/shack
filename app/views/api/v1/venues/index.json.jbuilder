...
json.venues @venues do |venue|
	json.extract! venue, :id, :name, :location, :user, :category, :description, :capacity, :activity, :price_cents, :latitude, :longitude, :perks, :average_rating, :reviews, :venue_spec, :published
